...
class PbsInfoBERCForm(forms.ModelForm):
    ...
    class Meta:
        model = PbsInfoBERC
        fields = ['complain_nos', 'month', 'year', 'complain_solve',
...
class UserForm(forms.ModelForm):
    ...
    password = forms.CharField(widget=forms.PasswordInput(
        attrs={'class': 'rounded form form-control bg-light col-md-8', 'placeholder': "Enter Password..."}))
...
class PBSInfoForm(forms.ModelForm):
    management = forms.ModelChoiceField(widget=forms.Select(
        attrs={'class': 'rounded form form-control bg-light col-md-8', }), queryset=ManagementInfo.objects.all())

    class Meta:
        model = PbsInfo
        fields = ['pbs_name', 'pbs_name_benglai',
                  'pbs_code', 'management', 'address', 'mobile_no']
        widgets = {
...
class NewOnlineConnectionForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = ['total_app', 'month', 'year',
                  'total_solve_app', 'cause_of_unsolve', 'remark']
...
class IndustryCommercialDcRcForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = ['total_dc_app', 'month', 'year',
                  'total_app_get_for_rc', 'complete_rc_app', 'illegal_app_for_dc']
...
class DcConsumerInfoForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = ['domestic', 'month', 'year', 'industry', 'commercial',
                  'irrigation', 'govt_institute', 'other', 'total_amount', 'taken_action']
...
class DomesticConnectionSevenDayForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = ['total_app', 'month', 'year', 'con_within_seven_day_app', 'con_without_seven_day_app',
                  'process_seven_day_app', 'reason_not_con_of_seven_day', 'remarks']
...
class MonthlyCoordinationMeetingInfoForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = ['consumer_meeting_nos', 'month', 'year', 'previous_month_unsolve_objection',
                  'current_month_unsolve_objection', 'total_objection', 'current_month_solve_objection', 'unsolve_objection', 'remarks']
...
class NecessaryActionAgainstAccidentForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = ['shift_cable', 'month', 'year', 'install_pole_for_unshift_cable', 'cover_cable_for_non_install_pole',
                  'span_length_sag_visit', 'risk_unfit_pole_change', 'pdb_risk_pole_check_change', 'electric_line_maintainance_by_instraction']
