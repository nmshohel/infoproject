...
class ManagementInfo(models.Model):
    ...
    management_status = models.BooleanField(
...
class PbsInfoBERC(models.Model):
    ...
    complain_unsolve_case = models.TextField(
...
class DomesticConnectionSevenDay(models.Model):
    ...
    year = models.CharField(max_length=10, blank=True, null=True)
    total_app = models.CharField(max_length=250, blank=True, null=True)
    con_within_seven_day_app = models.CharField(
        max_length=250, blank=True, null=True)
    con_without_seven_day_app = models.CharField(
        max_length=250, blank=True, null=True)
    process_seven_day_app = models.CharField(
        max_length=250, blank=True, null=True)
    reason_not_con_of_seven_day = models.TextField(
        max_length=250, blank=True, null=True)
...
class MonthlyCoordinationMeetingInfo(models.Model):
    ...
    month = models.CharField(max_length=10, blank=True, null=True)
    year = models.CharField(max_length=10, blank=True, null=True)
    consumer_meeting_nos = models.CharField(
        max_length=250, blank=True, null=True)
    previous_month_unsolve_objection = models.CharField(
        max_length=250, blank=True, null=True)
    current_month_unsolve_objection = models.CharField(
        max_length=250, blank=True, null=True)
    total_objection = models.CharField(max_length=250, blank=True, null=True)
    current_month_solve_objection = models.CharField(
        max_length=250, blank=True, null=True)
...
class NecessaryActionAgainstAccident(models.Model):
    ...
    install_pole_for_unshift_cable = models.CharField(
        max_length=250, blank=True, null=True)
    cover_cable_for_non_install_pole = models.CharField(
        max_length=250, blank=True, null=True)
    span_length_sag_visit = models.CharField(
        max_length=250, blank=True, null=True)
    risk_unfit_pole_change = models.CharField(
        max_length=250, blank=True, null=True)
    pdb_risk_pole_check_change = models.CharField(
        max_length=250, blank=True, null=True)
    electric_line_maintainance_by_instraction = models.TextField(
        max_length=250, blank=True, null=True)
...
class MeterDataRead(models.Model):
    # date_timee = models.DateTimeField(blank=True, null=True)
    # pbs_code = models.IntegerField(blank=True, null=True)
    month = models.CharField(max_length=10, blank=True, null=True)
    year = models.CharField(max_length=10, blank=True, null=True)
